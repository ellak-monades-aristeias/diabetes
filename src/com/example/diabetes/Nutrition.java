...
public class Nutrition extends Activity{
	...
	public void call(){
		int  randomInt;
		question_array[0][0]=R.string.se + "ένα ΠΑΓΩΤΟ ΧΩΝΑΚΙ(περίπου 85γρ.)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[1][0]=R.string.se + "μία μερίδα ΡΕΒΙΘΙΑ (περίπου 300γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[2][0]=R.string.se + "μία μερίδα ΚΑΛΑΜΑΡΑΚΙΑ (περίπου 120γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[3][0]=R.string.se + "μία μερίδα ΦΑΚΕΣ (περίπου 150γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[4][0]=R.string.se + "μία μερίδα ΑΡΑΚΑΣ (περίπου 300γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[5][0]=R.string.se + "μία μερίδα ΣΠΑΝΑΚΟΡΥΖΟ (περίπου 200γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[6][0]=R.string.se + "μία μερίδα ΓΕΜΙΣΤΑ ΜΕ ΡΥΖΙ (περίπου 250γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[7][0]=R.string.se + "μία μερίδα ΜΠΡΙΑΜ (περίπου 250γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[8][0]=R.string.se + "μία μερίδα ΝΤΟΛΜΑΔΑΚΙΑ (περίπου 100γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[9][0]=R.string.se + "μία μερίδα ΦΑΣΟΛΑΚΙΑ (περίπου 250γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[10][0]=R.string.se + "μία μεγάλη μερίδα ΛΑΖΑΝΙΑ ΜΕ ΚΡΕΑΣ(περίπου 454γρ)  ιταλικής κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[11][0]=R.string.se + "μία μικρή μερίδα ΛΑΖΑΝΙΑ ΜΕ ΚΡΕΑΣ(περίπου 284γρ)  ιταλικής κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[12][0]=R.string.se + "ένα κομμάτι ΤΙΡΑΜΙΣΟΥ(περίπου 141.75γρ)  ιταλικής κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[13][0]=R.string.se + "ένα μεγάλο πιάτο ΡΥΖΙ ΤΗΓΑΝΗΤΟ(περίπου 454γρ) κινέζικης κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[14][0]=R.string.se + "μεσαίου μεγέθους SPRING ROLLS(περίπου 85.0γρ) κινέζικης κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[15][0]=R.string.se + "ένα ΡΟΛΟ ΛΑΧΑΝΟΥ(περίπου 85γρ) λιβανέζικης κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[16][0]=R.string.se + "μία μερίδα SHAWOURMA(ΡΟΣΤ ΜΠΙΦ, περίπου 113.0γρ) λιβανέζικης κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[17][0]=R.string.se + "ένα κομμάτι ΣΠΑΝΑΚΟΠΙΤΑ(περίπου 99.0γρ) λιβανέζικης κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[18][0]=R.string.se + "ένα κομμάτι ΤΑΜΠΟΥΛΕ(περίπου 113.0γρ) λιβανέζικης κουζίνας" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[19][0]=R.string.se + "μία μερίδα PIZZA PEPPERONI CLASSIC(περίπου 78.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[20][0]=R.string.se + "μία μερίδα ΚΑΥΤΕΡΕΣ ΜΠΟΥΚΙΕΣ ΧΟΙΡΙΝΟΥ(περίπου 100.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[21][0]=R.string.se + "μία μερίδα CHICKEN KICKERS(περίπου 100.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[22][0]=R.string.se + "100.0γρ COOKIES(μπισκότα)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[23][0]=R.string.se + "100.0γρ MINI PANCAKES" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[24][0]=R.string.se + "μία μερίδα ΚΟΤΟΠΟΥΛΟ ΦΙΛΕΤΟ ΨΗΤΟ(περίπου 80.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[25][0]=R.string.se + "μία μερίδα ΜΠΙΦΤΕΚΙ(περίπου 75.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[26][0]=R.string.se + "μία μερίδα ΛΟΥΚΑΝΙΚΟ ΡΙΓΑΝΑΤΟ(περίπου 100.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[27][0]=R.string.se + "μία μερίδα ΣΟΛΟΜΟ(περίπου 30.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[28][0]=R.string.se + "μία μερίδα ΦΡΕΣΚΑ ΜΑΝΙΤΑΡΙΑ(περίπου 50.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[29][0]=R.string.se + "50.0γρ ΑΥΓΟ" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[30][0]=R.string.se + "20.0γρ ΚΑΡΥΔΙΑ" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[31][0]=R.string.se + "μία μερίδα ΟΜΕΛΕΤΑ(περίπου 70.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[32][0]=R.string.se + "60.0γρ ΠΑΤΑΤΕΣ ΤΗΓΑΝΗΤΕΣ" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[33][0]=R.string.se + "μία μερίδα ΣΑΛΑΤΑ CAESAR' S(περίπου 230.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[34][0]=R.string.se + "μία μερίδα ΕΛΛΗΝΙΚΗ ΣΑΛΑΤΑ(περίπου 230.0γρ)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[35][0]=R.string.se + "μία ΑΡΑΒΙΚΗ ΠΙΤΑ(περίπου 100γρ.)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[36][0]=R.string.se + "ένα ΚΟΥΛΟΥΡΙ ΜΕ ΣΟΥΣΑΜΙ(περίπου 120γρ.)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[37][0]=R.string.se + "ένα CHEESE BURGER(περίπου 176γρ.)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[38][0]=R.string.se + "ένα Goody’s club(περίπου 340γρ.)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[39][0]=R.string.se + "ένα Big Mac(περίπου 221γρ.)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[40][0]=R.string.se + "ένα McChicken(περίπου 220γρ.)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
		...
		question_array[41][0]=R.string.se + "ένα Milk shake σε γεύση σοκολάτας(περίπου 400ml)" + R.string.posaIsodynamaYdatan8rakwnYparxoyn;
