...
public class Nutrition extends Activity{
	...
	public void call(){
		int  randomInt;
		question_array[0][0]=getString(R.string.se) + "μία μερίδα ΠΑΣΤΙΤΣΙΟ (περίπου 260γρ)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[10][0]=getString(R.string.se) + "170γρ Βratwurst ψητό γερμανικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[11][0]=getString(R.string.se) + "113.4γρ Μagura (τόννος) ιαπωνικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[12][0]=getString(R.string.se) + "113.4γρ Taco (χταπόδι) ιαπωνικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[13][0]=getString(R.string.se) + "113.4γρ Τeriyaki (κρέας) ιαπωνικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[14][0]=getString(R.string.se) + "56.7γρ Naan πίτα ινδικής και πακιστανικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[15][0]=getString(R.string.se) + "74.0γρ Pesarattu κρέπα φακής ινδικής και πακιστανικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[16][0]=getString(R.string.se) + "312.0γρ 	ΚΟΤΟΠΟΥΛΟ ΜΕ ΠΑΡΜΕΖΑΝΑ ιταλικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[17][0]=getString(R.string.se) + "μία μικρή μερίδα ΛΑΖΑΝΙΑ ΜΕ ΚΡΕΑΣ(περίπου 284γρ)  ιταλικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[18][0]=getString(R.string.se) + "ένα κομμάτι ΤΙΡΑΜΙΣΟΥ(περίπου 141.75γρ)  ιταλικής κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[19][0]=getString(R.string.se) + "170.0γρ ΚΟΤΟΠΟΥΛΟ ΜΕ ΑΜΥΓΔΑΛΑ κινέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[20][0]=getString(R.string.se) + "170.0γρ ΛΑΧΑΝΙΚΑ ΣΤΟΝ ΑΤΜΟ ΜΕ ΛΑΔΙ κινέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[21][0]=getString(R.string.se) + "170.0γρ ΜΟΣΧΑΡΙ ΜΕ ΜΠΡΟΚΟΛΟ κινέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[22][0]=getString(R.string.se) + "142.0γρ ΡΥΖΙ ΤΗΓΑΝΗΤΟ κινέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[23][0]=getString(R.string.se) + "85.0γρ SPRING ROLLS κινέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[24][0]=getString(R.string.se) + "142.0γρ ΧΟΙΡΙΝΟ ΜΕ ΣΑΛΤΣΑ ΜΠΑΡΜΠΕΚΙΟΥ κινέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[25][0]=getString(R.string.se) + "42.0γρ ΜΠΑΚΛΑΒΑ λιβανέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[26][0]=getString(R.string.se) + "1 μερίδα SHAWOURMA(ΡΟΣΤ ΜΠΙΦ, περίπου 113.0γρ) λιβανέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[27][0]=getString(R.string.se) + "1 κομμάτι ΣΠΑΝΑΚΟΠΙΤΑ(περίπου 99.0γρ) λιβανέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[28][0]=getString(R.string.se) + "1 κομμάτι ΤΑΜΠΟΥΛΕ(περίπου 113.0γρ) λιβανέζικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[29][0]=getString(R.string.se) + "482.0γρ ΜΠΟΥΡΙΤΟΣ ΜΕ ΦΑΣΟΛΙΑ Ή ΚΡΕΑΣ μεξικάνικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[30][0]=getString(R.string.se) + "100.0γρ ΤΑΜΑΛΕΣ μεξικάνικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[31][0]=getString(R.string.se) + "142.0γρ ΤΑΚΙΤΟΣ μεξικάνικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[32][0]=getString(R.string.se) + "28.0γρ ΤΣΙΠΣ ΤΟΡΤΙΓΙΑΣ μεξικάνικης κουζίνας" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[33][0]=getString(R.string.se) + "μία μερίδα PIZZA PEPPERONI CLASSIC(περίπου 78.0γρ)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[34][0]=getString(R.string.se) + "μία μερίδα ΚΑΥΤΕΡΕΣ ΜΠΟΥΚΙΕΣ ΧΟΙΡΙΝΟΥ(περίπου 100.0γρ)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[35][0]=getString(R.string.se) + "μία μερίδα CHICKEN KICKERS(περίπου 100.0γρ)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[36][0]=getString(R.string.se) + "100.0γρ COOKIES(μπισκότα)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[37][0]=getString(R.string.se) + "100.0γρ MINI PANCAKES" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[38][0]=getString(R.string.se) + "80.0γρ ΚΟΤΟΠΟΥΛΟ ΦΙΛΕΤΟ ΨΗΤΟ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[39][0]=getString(R.string.se) + "75.0γρ ΜΠΙΦΤΕΚΙ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[40][0]=getString(R.string.se) + "100.0γρ ΛΟΥΚΑΝΙΚΟ ΡΙΓΑΝΑΤΟ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[41][0]=getString(R.string.se) + "30.0γρ ΣΟΛΟΜΟ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[42][0]=getString(R.string.se) + "50.0γρ ΦΡΕΣΚΑ ΜΑΝΙΤΑΡΙΑ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[43][0]=getString(R.string.se) + "50.0γρ ΑΥΓΟ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[44][0]=getString(R.string.se) + "20.0γρ ΚΑΡΥΔΙΑ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[45][0]=getString(R.string.se) + "70.0γρ ΟΜΕΛΕΤΑ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[46][0]=getString(R.string.se) + "60.0γρ ΠΑΤΑΤΕΣ ΤΗΓΑΝΗΤΕΣ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[47][0]=getString(R.string.se) + "230.0γρ ΣΑΛΑΤΑ CAESAR' S" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[48][0]=getString(R.string.se) + "230.0γρ ΕΛΛΗΝΙΚΗ ΣΑΛΑΤΑ" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[49][0]=getString(R.string.se) + "μία ΑΡΑΒΙΚΗ ΠΙΤΑ(περίπου 100γρ.)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[50][0]=getString(R.string.se) + "ένα ΚΟΥΛΟΥΡΙ ΜΕ ΣΟΥΣΑΜΙ(περίπου 120γρ.)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[51][0]=getString(R.string.se) + "ένα CHEESE BURGER(περίπου 176γρ.)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[52][0]=getString(R.string.se) + "ένα Goody’s club(περίπου 340γρ.)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[53][0]=getString(R.string.se) + "ένα Big Mac(περίπου 221γρ.)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[54][0]=getString(R.string.se) + "ένα McChicken(περίπου 220γρ.)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[55][0]=getString(R.string.se) + "ένα Milk shake σε γεύση σοκολάτας(περίπου 400ml)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
		...
		question_array[56][0]=getString(R.string.se) + "ένα ΠΑΓΩΤΟ ΧΩΝΑΚΙ(περίπου 85γρ.)" + getString(R.string.posaIsodynamaYdatan8rakwnYparxoyn);
